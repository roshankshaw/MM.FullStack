								      ...
								      <div class="panel-body">
											<div class="row">
												<div class="col-md-2 col-md-offset-2">
													<?= anchor("comments/unapprove_comment/{$comment->comment_id}",'Unapprove',['class'=>'btn btn-primary'])?>
												</div>
												<div class="col-md-1">
													<?=
														form_open('comments/delete_comment'),
														form_hidden('comment_id',$comment->comment_id),
														form_submit(['name'=>'submit','value'=>'Delete','class'=>'btn btn-outline-danger','onclick'=>"return(confirm('Are you sure you want to delete this comment?'))"]),
														form_close();
													?>
												</div>
											</div>
