				...
				<div id="demoq" class="carousel slide" data-ride="carousel">
					...
					<div class="carousel-inner">
					  <div class="carousel-item active">
						<img src="<?=base_URL('assets/images/article1.png')?>" alt="Los Angeles">
					  </div>
					  <div class="carousel-item">
						<img src="<?=base_URL('assets/images/article1.png')?>" alt="Chicago">
					  </div>
					  <div class="carousel-item">
						<img src="<?=base_URL('assets/images/article1.png')?>" alt="New York">
					  </div>
					</div>
			...
			<div class=" featured-stories col-md-6 col-sm-12"> 
				<div class="row">
					<div class="col-md-6 col-sm-12" >
							<div class="post-new">
								<img src="<?=base_URL('assets/images/article2.jpg')?>" alt="newpost" class="img-fluid newtop">        
							...
							<li class="list-group-item"><a href="#">
								<div class="row">
									<div class="articles col-md-6 col-sm-12">
										<img src="<?=base_URL('assets/images/article3.jpg')?>" alt="" class="img-fluid">
									</div>
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolorum?</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eaque!</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Incidunt.</article>
									</div>
								</div>
							</a></li>
						</ul>
						...
						<ul class="list-group">
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Pariatur.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellat.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolores.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Alias.</article>
									</div>
								</div>
							</a></li>
							</ul>
						...
						<ul class="list-group">
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quibusdam!</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Explicabo.</article>
									</div>
								</div>
							</a></li>
						</ul>
						...
						<ul class="list-group">
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veritatis.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laborum.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit.</article>
									</div>
								</div>
							</a></li>
							<li class="list-group-item"><a href="#">
								<div class="row">
									...
									<div class="article-content col-md-6 col-sm-12 w-100 small">
										<article>	Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nisi.</article>
									</div>
								</div>
							</a></li>
						</ul>
							...
							<div id="comments">
								<ul class="list-group">
									<li class="list-group-item"><a href="#">
										<div class="row">
											<div class="articles col-md-6 col-sm-12">
												<img src="images/user1.jpg" alt="" class="img-fluid cmtimg">
											</div>
											<div class="article-content cmtpost col-md-6 col-sm-12 w-100 small">
												<article class="nice-post text-left">Hi! Nice post</article>
											</div>
										</div>
									</a></li>
									<li class="list-group-item"><a href="#">
		...
		<div class="row">
			...
			<div id="demop" class="carousel slide" data-ride="carousel">
				...
				<div class="carousel-inner">
				  	<div class="carousel-item active">
						<div class="row">
           					<div class="col-md-3 col-sm-6"><img class="img-fluid" src="<?base_URL('assets/images/article3.jpg');?>" alt="1 slide"></div>
           					<div class="col-md-3 col-sm-6"><img class="img-fluid" src="<?base_URL('assets/images/article3.jpg');?>" alt="2 slide"></div>
           					<div class="col-md-3 col-sm-6"><img class="img-fluid" src="<?base_URL('assets/images/article3.jpg');?>" alt="3 slide"></div>
           					<div class="col-md-3 col-sm-6"><img class="img-fluid" src="<?base_URL('assets/images/article3.jpg');?>" alt="4 slide"></div>
       					</div>
				  	</div>
				  	<div class="carousel-item">
						<div class="row">
